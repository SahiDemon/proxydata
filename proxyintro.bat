...
echo                   -@``                 y@@@@@@@@@@@@@@@@@@@@@@@@@@@N@-d@@N-``o@:                   
echo                   h/                   y@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@h--.```.s@                   
echo                  .NN@y.`                 hh@@@@@@dhhhN@@@@@@@@@@@@@@@@@@@s````-N:         Proxy Manager By
echo                  /dN@@@o`                 `yyyyyy    syN@@@@@@@@@@@@@@@@h+`````so         SahiDemon V3.1.0
echo                  o@@@@@@s//                            h@@@@@@@@@@@@@Nd+-``````oy         
echo                  +N@@@@@@@No++                         h@@@@@@@@@@@@@d:.```````ss                  
echo                  .N@@@@@@@@@@@`                        /+N@@@@@@@@@@@s`````````d:                 
echo                   dh@@@@@@@@N/`                          @@@@@@@@@@@@/````````:@                   
...
echo                   -@``                  `@@@@@@@@@@@@@@@@@@@@@@@@@@@N@:h@@d.`-@:                   
echo                   h/ `                  .d@@@@@@@@@@@@@@@@@@@@@@@@@@@@@d--.```/@                   
echo                  .Ny@@+.`                 :h@@@@@@Nhhhd@@@@@@@@@@@@@@@@@@@o````@:         Proxy Manager By
echo                  /hh@@@@+`                  -yyyyyo   `yh@@@@@@@@@@@@@@@@h/````so         SahiDemon V3.1.0
echo                  oh@@@@@@s//                            `@@@@@@@@@@@@@@@o-`````oy                  
echo                  +h@@@@@@@@@o++.                        `@@@@@@@@@@@@@N/.``````ss                  
echo                  .N@@@@@@@@@@@@+                        `+s@@@@@@@@@@@d````````d:                  
echo                   doN@@@@@@@@@+-                          :@@@@@@@@@@@o```````:@                   
...
echo                   -@```                   o@@@@@@@@@@@@@@@@@@@@@@@@@@N@/h@@s`.@:                   
echo                   ho ``                   odN@@@@@@@@@@@@@@@@@@@@@@@@@@@@--.``:@                   
echo                  .N/@@@:.`                  ohN@@@@@@hhh@@@@@@@@@@@@@@@@@@@/```d:         Proxy Manager By         
echo                  /h/@@@@@+.                   +yyyyy:   /yd@@@@@@@@@@@@@@Ny:```so         SahiDemon V3.1.0         
echo                  oyd@@@@@@y//.                            +@@@@@@@@@@@@@@o-````oy                  
echo                  +hh@@@@@@@@@y++/                         +@@@@@@@@@@@@@/.`````ss                  
echo                  .No@@@@@@@@@@@@d                         -+d@@@@@@@@@@@```````d:                  
echo                   d/y@@@@@@@@@@y:                           h@@@@@@@@@@y``````:@                   
...
echo                   -@` .                     @@@@@@@@@@@@@@@@@@@@@@@@@@@@/h@@:.d:                   
echo                   hs ```                    d@@@@@@@@@@@@@@@@@@@@@@@@@@@@d--.`:@                   
echo                  .N.d@@N--`                   hh@@@@@@dhhdN@@@@@@@@@@@@@@@@N-``d:         Proxy Manager By          
echo                  /h`d@@@@@o.                    yyyyyy`   shN@@@@@@@@@@@@@@y-``so         SahiDemon V3.1.0         
echo                  oy+@@@@@@@h//-                             @@@@@@@@@@@@@@o.```oy                  
echo                  +h/@@@@@@@@@@@+++`                         @@@@@@@@@@@@@/.````ss                  
echo                  .N.@@@@@@@@@@@@@@:                         +o@@@@@@@@@@N``````d:                  
echo                   d/:@@@@@@@@@@@@/.                          -@@@@@@@@@@y`````:@                   
...
echo                   -N.  .                     :@@@@@@@@@@@@@@@@@@@@@@@@@@@/@@d.d:                   
echo                   hs.````                    :d@@@@@@@@@@@@@@@@@@@@@@@@@@@h--`:@                   
echo                  .N /@@@N--`                   -hd@@@@@Nhhd@@@@@@@@@@@@@@@@@d``d:         Proxy Manager By         
echo                  /h /@@@@@@s-                    .yyyyys   -hd@@@@@@@@@@@@@@s.`so         SahiDemon V3.1.0         
echo                  oy @@@@@@@@@///                             :@@@@@@@@@@@@@+.``oy                  
echo                  +h @@@@@@@@@@@@o++:                         :@@@@@@@@@@@@/.```ss                  
echo                  .N y@@@@@@@@@@@@@@h                         .+d@@@@@@@@@N`````d:                  
echo                   d/`y@@@@@@@@@@@@o:                           h@@@@@@@@@y````:@                   
...
echo                   -@-   `                      y@@@@@@@@@@@@@@@@@@@@@@@@N@/N@/d:                   
echo                   h+/ ````                     odN@@@@@@@@@@@@@@@@@@@@@@@@@s-.:@                   
echo                  .N `y@@@N--.                    +h@@@@@@@hddN@@@@@@@@@@@@@@@+`d:         Proxy Manager By         
echo                  /h `y@@@@@@h:`                    /yyyyy/  `ohN@@@@@@@@@@@@d/`so         SahiDemon V3.1.0         
echo                  oy /@@@@@@@@@+//-                             h@@@@@@@@@@@@/``oy                  
echo                  +h :@@@@@@@@@@@@h+++`                         d@@@@@@@@@@@/```ss                  
echo                  .N `@@@@@@@@@@@@@@@@:                         /s@@@@@@@@@@````d:                  
echo                   d/ -N@@@@@@@@@@@@d/.                          /@@@@@@@@@o```:@                   
...
echo                   -N+`  ``                       N@@@@@@@@@@@@@@@@@@@@@@@Ndo@yd:                   
echo                   h//.`````                      d@@@@@@@@@@@@@@@@@@@@@@@@@N/-:@                   
echo                  .N  :d@@@@:--                     yh@@@@@@ddd@@@@@@@@@@@@@@@N.d:         Proxy Manager By         
echo                  /h  -d@@@@@@N:.                     syyyyy` `.hd@@@@@@@@@@@@h.so         SahiDemon V3.1.0         
echo                  oy  h@@@@@@@@@y///                             :@@@@@@@@@@@h-`oy                  
echo                  +h  y@@@@@@@@@@@@@+++/                         :@@@@@@@@@@@:``ss                  
echo                  .N  +@@@@@@@@@@@@@@@@@                         -o@@@@@@@@@y```d:                  
echo                   d/ `/@@@@@@@@@@@@@@+/                         ``N@@@@@@@@/``:@                   
...
echo                   -@s.   ``                       /@@@@@@@@@@@@@@@@@@@@@@@NydNd:                   
echo                  h/`o ``````                     -d@@@@@@@@@@@@@@@@@@@@@@@@d-/@                   
echo                  .N   /@@@@@+--`                    -hd@@@@@NhddN@@@@@@@@@@@@@+d:         Proxy Manager By         
echo                  /h   :N@@@@@@@+:                     .yyyhho ``ohN@@@@@@@@@@N/so         SahiDemon V3.1.0         
echo                  oy   N@@@@@@@@@N///-                             @@@@@@@@@@Ns.oy                  
echo                  +h   @@@@@@@@@@@@@@h+++.                       ``@@@@@@@@@@h-`ss                  
echo                  .N   h@@@@@@@@@@@@@@@@@o                       ``+h@@@@@@@@+``d:     	            
echo                   d/  .o@@@@@@@@@@@@@@d/-                        ``y@@@@@@@N.`:@                   
...
echo                   -@s:`   ``                        h@@@@@@@@@@@@@@@@@@@@@@@s@N:                   
echo                   h/`:/ ````.`                      odN@@@@@@@@@@@@@@@@@@@@@@o/@                   
echo                  .N   `oN@@@@y--.                     +h@@@@@@ddd@@@@@@@@@@@@@dd:         Proxy Manager By         
echo                  /h    :@@@@@@@@h:`                     /yhhhh- .:h@@@@@@@@@@@hso         SahiDemon V3.1.0         
echo                  oy   .@@@@@@@@@@@s///                           ``o@@@@@@@@@@:oy                  
echo                  +h   `@@@@@@@@@@@@@@@o+++                       ``s@@@@@@@@@o`ss                  
echo                  .N    @@@@@@@@@@@@@@@@@@@.                      ``/s@@@@@@@@.`d:   		               
echo                   d/   -s@@@@@@@@@@@@@@@s/`                      ```/@@@@@@@h`:@                   
...
echo                   -@/y.    ``                        `@@@@@@@@@@@@@@@@@@@@@Ndd@:                   
echo                   h/  o- ```..`                       d@@@@@@@@@@@@@@@@@@@@@@@/@                   
echo                  .N    `oN@@@@@---                      yh@@@@@Nddd@@@@@@@@@@@N@:         Proxy Manager By         
echo                  /h    `:@@@@@@@@@/:                      shhhhs ..yd@@@@@@@@@Nho         SahiDemon V3.1.0         
echo                  oy    :@@@@@@@@@@@N///:                         ```-@@@@@@@@@soy                  
echo                  +h    -@@@@@@@@@@@@@@@@+++/                     ```-@@@@@@@@N-ss                  
echo                  .N    `N@@@@@@@@@@@@@@@@@@d                     ```-oN@@@@@@y`d:                  
echo                   d/    -y@@@@@@@@@@@@@@@N/:                     ````-@@@@@@@/:@                   
...
echo                   -@.s+.    ``                         +@@@@@@@@@@@@@@@@@@@@@y@:                   
echo                   h/   h````....                       :@@@@@@@@@@@@@@@@@@@@@Ns@                   
echo                  .N     `oN@@@@@/--.                     -h@@@@@@dd@N@@@@@@@@@@@:         Proxy Manager By         
echo                  /h     `:N@@@@@@@@h:.                     -hhhhh-`-+h@@@@@@@@@@o         SahiDemon V3.1.0         
echo                  oy     :@@@@@@@@@@@@y///.                       `````@@@@@@@@@sy                  
echo                  +h     -@@@@@@@@@@@@@@@@y+++-                   ```.`N@@@@@@@sss                  
echo                  .N     `@@@@@@@@@@@@@@@@@@@@+                   ````.+@@@@@@@-d:                  
echo                   d/     :y@@@@@@@@@@@@@@@@h/-                  ``````.N@@@@@d:@                   
...
echo                   -@`/h:`     `                          @@@@@@@@@@@@@@@@@@@@hN:                   
echo                   h/   `d```.....`                       y@N@@@@@@@@@@@@@@@@@@d@                   
echo                  .N      `o@@@@@@y---`                     ohN@@@@Nd@@@@@@@@@@@@:         Proxy Manager By         
echo                  /h      `:@@@@@@@@@@+:                      ohhhho`-/hN@@@@@@@No         SahiDemon V3.1.0         
echo                  oy      -@@@@@@@@@@@@@+///                       `````h@@@@@@@hy                  
echo                  +h      -@@@@@@@@@@@@@@@@@++++`                  `````d@@@@@@@ys                  
echo                  .N      `N@@@@@@@@@@@@@@@@@@@@.                ` `````+d@@@@@sd:                  
echo                   d/      :s@@@@@@@@@@@@@@@@@o/`                ````````@@@@@@+@                   
...
echo                   -@`.oh.`     `                          /@@@@@@@@@@@@@@@@@@@@:                   
echo                   h/    `d```......                       .@@@@@@@@@@@@@@@@@@@N@                   
echo                  .N       `+d@@@@@@:--.                     .hd@@@@@d@@@@@@@@@@@:         Proxy Manager By         
echo                  /h        :h@@@@@@@@@d:-                     .hhhhh`.-h@@@@@@@@o         SahiDemon V3.1.0         
echo                  oy       .@@@@@@@@@@@@@d///:                     ``````y@@@@@@Ny                  
echo                  +h       `@@@@@@@@@@@@@@@@@@+++/               ` ``````y@@@@@@hs                  
echo                  .N        @@@@@@@@@@@@@@@@@@@@@@               ` ``````/d@@@@@d:                  
echo                   d/       -+@@@@@@@@@@@@@@@@@@//               `````````@@@@@h@                   
...
echo                   -@` -yh.`     `                           d@@@@@@@@@@@@@@@@NN:                   
echo                   h/     .d```......`                       o@N@@@@@@@@@@@@@@@@@                   
echo                  .N        `+y@@@@@@y---`                     +dN@@@@@d@@@@@@@@@:         Proxy Manager By         
echo                  /h         :o@@@@@@@@@@s:`                     ohhhh:.-y@@@@@@@o         SahiDemon V3.1.0         
echo                  oy         N@@@@@@@@@@@@@s///.                   ```````s@@@@@@y                  
echo                  +h         @@@@@@@@@@@@@@@@@@y+++-              ````````y@@@@@Ns                  
echo                  .N         h@@@@@@@@@@@@@@@@@@@@@o              ````````/d@@@@N:                  
echo                   d/        -/N@@@@@@@@@@@@@@@@@h/-              ````````.N@@@N@                   
...
echo                   -@` `-yh``      `                          :@@@@@@@@@@@@@@@@@:                   
echo                   h/      `d-``.......                       `@@@@@@@@@@@@@@@@@@                   
echo                  .N         `:oN@@@@@@:---                     .d@@@@@@d@@@@@@@@:         Proxy Manager By         
echo                  /h          -/@@@@@@@@@@N/:                     -hhhh+`-y@@@@@@o         SahiDemon V3.1.0         
echo                  oy          y@@@@@@@@@@@@@@+///`                ``.``````s@@@@@y                  
echo                  +h          y@@@@@@@@@@@@@@@@@@o+++.            `````````y@@@@@s                  
echo                  .N          o@@@@@@@@@@@@@@@@@@@@@@-            `````````/@@@@@:                  
echo                   d/         ./d@@@@@@@@@@@@@@@@@@o/`            `````````-@@@@@                   
...
echo                   -@`  .:yd.`      `                           @@@@@@@@@@@@@@@@:                   
echo                   h/        d/ ``.......                       s@@@@@@@@@@@@@@@@                   
echo                  .N          `.od@@@@@@d---.                     sd@@@@N@@@@@@@@:         Proxy Manager By         
echo                  /h           `:h@@@@@@@@@@d:-                   ``yhhho`-yN@@@@o         SahiDemon V3.1.0         
echo                  oy           /@@@@@@@@@@@@@@d////               ``````````h@@@@y                  
echo                  +h           :@@@@@@@@@@@@@@@@@@N++++           ``````````h@@@@s                  
echo                  .N           -@@@@@@@@@@@@@@@@@@@@@@N           ``````````+@@@@:                  
echo                   d/           /o@@@@@@@@@@@@@@@@@@N//           ``````````/@@@@                   
...
echo                   -@`   ./yd.`                                  o@@@@@@@@@@@@@@:                   
echo                   h/         ss ``.......`                      -@N@@@@@@@@@@@@@                   
echo                  .N            `+s@@@@@@@o---`                    :dN@@@N@@@@@@@:         Proxy Manager By         
echo                  /h             :+@@@@@@@@@@@s:.                 ```+hhhs`-h@@@@o         SahiDemon V3.1.0         
echo                  oy            `@@@@@@@@@@@@@@@y///-             ```````````@@@@y                  
echo                  +h             N@@@@@@@@@@@@@@@@@@h+++:         ```````````N@@@s                  
echo                  .N             d@@@@@@@@@@@@@@@@@@@@@@s         ``````````.s@@@:                  
echo                   d/            -/N@@@@@@@@@@@@@@@@@@h/-        ````````````y@@@                   
...
echo                   -@`   `.:yd-`                                 `.N@@@@@@@@@@@@:                   
echo                   h/          /d```........                       h@@@@@@@@@@@@@                   
echo                  .N             `:o@@@@@@@N:---                   ``h@@@@N@@@@@@:         Proxy Manager By         
echo                  /h              .:d@@@@@@@@@@@/:                 ```:hhhs`:d@@@o         SahiDemon V3.1.0         
echo                  oy              s@@@@@@@@@@@@@@@+///`            ``````````-@@@y                  
echo                  +h              o@@@@@@@@@@@@@@@@@@@s+++.      ` ``````````:@@@s                  
echo                  .N              +@@@@@@@@@@@@@@@@@@@@@@@-      ` ``````````-@@@:                  
echo                   d/             `/y@@@@@@@@@@@@@@@@@@@o/`      ````````````.N@@                   
...
echo                   -@`    `.:yd+``                                ``d@@@@@@@@@@@:                   
echo                   h/           .@/ ``.......`                    ``o@@@@@@@@@@@@                   
echo                  .N              ``+s@@@@@@@h----                 ```s@@@@N@N@@@:         Proxy Manager By         
echo                  /h                :+@@@@@@@@@@@@::               ````.hhhs.+@@@o         SahiDemon V3.1.0         
echo                  oy               `@@@@@@@@@@@@@@@@////           ```````````o@@y                  
echo                  +h               `@@@@@@@@@@@@@@@@@@@N++++     ` ```````````s@@s                  
echo                  .N                N@@@@@@@@@@@@@@@@@@@@@@@     `````````````+@@:                  
echo                   d/               :/N@@@@@@@@@@@@@@@@@@@/:     `````````````o@@                   
...
echo                   -@`     ``-ydy``                               ```y@@@@@@@@@@:                   
echo                   h/             yh ``........`                  ```:@N@@@@@@@@@                   
echo                  .N                `:od@@@@@@@o---.              `````+d@@@N@@@@:         Proxy Manager By         
echo                  /h                 .:h@@@@@@@@@@@y:.            ``.````yhh+.s@@o         SahiDemon V3.1.0         
echo                  oy                 s@@@@@@@@@@@@@@@h///-        `````````````N@y                  
echo                  +h                 o@@@@@@@@@@@@@@@@@@@d+++-    ``.``````````N@s                  
echo                  .N                 +@@@@@@@@@@@@@@@@@@@@@@@+    ````````````.d@:                  
echo                   d/                ./s@@@@@@@@@@@@@@@@@@@y/.    ````````````.N@                   
...
echo                   -@`      ```shd.``                             ````+@@@@@@@@@:                   
echo                   h/              :@: ``........                 ```..@N@@@@@@@@                   
echo                  .N                 `.+o@@@@@@@@:---`            ``````/d@@@@N@@:         Proxy Manager By         
echo                  /h                   :/@@@@@@@@@@@@+:`          ````````yhh::@@o         SahiDemon V3.1.0         
echo                  oy                   N@@@@@@@@@@@@@@@o///.      `````````````o@y                  
echo                  +h                   N@@@@@@@@@@@@@@@@@@@s+++`  `````````````o@s                  
echo                  .N                   @@@@@@@@@@@@@@@@@@@@@@@N`  `````````````o@:                  
echo                   d/                  :/@@@@@@@@@@@@@@@@@@@N+/   `````````````y@                   
...
echo                   -@`       ```+h@+```                          ` ```./@@@@@@@@:                   
echo                   h/                hh ``.........               ``````dN@@@@@@@                   
echo                  .N                   `:oh@@@@@@@d----           ```.```:@@@@@@@:         Proxy Manager By         
echo                  /h                    .:s@@@@@@@@@@@N::         `````````yhh.s@o         SahiDemon V3.1.0         
echo                  oy                    /@@@@@@@@@@@@@@@N+///     `````````````.@y                  
echo                  +h                    /@@@@@@@@@@@@@@@@@@@N+++: `````````````.@s                  
echo                  .N                    :@@@@@@@@@@@@@@@@@@@@@@@o `````````````-@:                  
echo                   d/                   `/o@@@@@@@@@@@@@@@@@@@h/. `````````````+@                   
...
echo                   -@`         ``:ydd```                         ```.``.:@@@@@@@:                   
echo                   h/                 :d/ ``........`              ```.``dN@@@@@@                   
echo                  .N                    `.+o@@@@@@@@s---.          ```````:@@@NN@:         Proxy Manager By         
echo                  /h                      -:d@@@@@@@@@@@h:.        `````````hho:No         SahiDemon V3.1.0         
echo                  oy                      h@@@@@@@@@@@@@@@h///-   ``````````````dy                  
echo                  +h                      h@@@@@@@@@@@@@@@@@@@h+o+``````````````ds                  
echo                  .N                      y@@@@@@@@@@@@@@@@@@@@@@N``````````````@:                  
echo                   d/                     -/h@@@@@@@@@@@@@@@@@@@+/`````````````:@                   
...
echo                   -@`          ```yh@/ ``                        ``.````:@@@@@@:                   
echo                   h/                   yd``..........             ```````d@@@@@@                   
echo                  .N                      .-os@@@@@@@@/---`        ````````/@@@@@:         Proxy Manager By         
echo                  /h                        :/@@@@@@@@@@@@o:`      `````````-hh:@o         SahiDemon V3.1.0         
echo                  oy                       `@@@@@@@@@@@@@@@@o/+/   `````````````oy                  
echo                  +h                       `@@@@@@@@@@@@@@@@@@@@ooo:````````````ys                  
echo                  .N                       `@@@@@@@@@@@@@@@@@@@@@@@+````````````d:                  
echo                   d/                       /+N@@@@@@@@@@@@@@@@@@y+.```````````:@                   
...
echo                   -@`           ```+y@d````                      ```.````/@@@@@:                   
echo                   h/                    .do `..........          ``.``````@@@@@@                   
echo                  .N                       `./oh@@@@@@@@----       `````````oN@N@:         Proxy Manager By         
echo                  /h                         .:o@@@@@@@@@@@N::     ``````````/hoyo         SahiDemon V3.1.0         
echo                  oy                         /@@@@@@@@@@@@@@@@/++- `````````````oy                  
echo                  +h                         /@@@@@@@@@@@@@@@@@@@hoo+```````````ss                  
echo                  .N                         /@@@@@@@@@@@@@@@@@@@@@@d```````````d:                  
echo                   d/                        ./s@@@@@@@@@@@@@@@@@@N+:``````````:@                   
...
echo                   -@`             ``.yh@+ ``                     ```.`````s@@@@:                   
echo                   h/                      od-``.........`        `````````.N@@@@                   
echo                  .N                         `.+o@@@@@@@@s---.    ```````````y@@N:         Proxy Manager By         
echo                  /h                           -:h@@@@@@@@@@@y:.  ````````````shyo         SahiDemon V3.1.0         
echo                  oy                           h@@@@@@@@@@@@@@@y+++`````````````oy                  
echo                  +h                           y@@@@@@@@@@@@@@@@@@Nooo.`````````ss                  
echo                  .N                           y@@@@@@@@@@@@@@@@@@@@@@.`````````d:                  
echo                   d/                          :/d@@@@@@@@@@@@@@@@@@o/`````````:@                   
...
echo                   -@`              `` +h@@` ``                   ````.`````h@@@:                   
echo                   h/                        dh``..........       ``````````/N@@@                   
echo                  .N                           .-osN@@@@@@@:---   ```````````.@@@:         Proxy Manager By         
echo                  /h                             :/N@@@@@@@@@@N/: ````````````-hdo         SahiDemon V3.1.0         
echo                  oy                            `N@@@@@@@@@@@@@@N+++-```````````oy                  
echo                  +h                            `N@@@@@@@@@@@@@@@@@@yoo:````````ss                  
echo                  .N                             N@@@@@@@@@@@@@@@@@@@@@:````````d:                  
echo                   d/                            /+N@@@@@@@@@@@@@@@@@h+````````:@                   
...
echo                   -@`                  `yh@s ```                ` ```.`````-N@@:                   
echo                   h/                         :do``.........`      ``````````s@@@                   
echo                  .N                            `-/sy@@@@@@@d-:-. ````````````oN@:         Proxy Manager By         
echo                  /h                              `:+@@@@@@@@@@@h/.````````````o@o         SahiDemon V3.1.0         
echo                  oy                              :@@@@@@@@@@@@@@@y++/``````````oy                  
echo                  +h                              :@@@@@@@@@@@@@@@@@@@oo/```````ss                  
echo                  .N                              :@@@@@@@@@@@@@@@@@@@@@+```````d:                  
echo                   d/                             ./s@@@@@@@@@@@@@@@@@d+.``````:@                   
...
echo                   -@`                    /hd@: ``               ```.``.`````o@@:                   
echo                   h/                           od:``.........     ``````````.N@@                   
echo                  .N                              .-+sd@@@@@@@+::-````````````.@@:         Proxy Manager By         
echo                  /h                                .:y@@@@@@@@@@@/:```````````-@o         SahiDemon V3.1.0         
echo                  oy                                s@@@@@@@@@@@@@@@+++`````````oy                  
echo                  +h                                s@@@@@@@@@@@@@@@@@Noo/``````ss                  
echo                  .N                                s@@@@@@@@@@@@@@@@@@@@o``````d:                  
echo                   d/                               -/d@@@@@@@@@@@@@@@@N+.`````:@                   
...
echo                   -@`                      yh@d` ``      `       ``.````````.N@:                   
echo                   h/                             dd``..........  `````.``````o@@                   
echo                  .N                                -:osN@@@@@@@-::..``````````o@:         Proxy Manager By         
echo                  /h                                  ::@@@@@@@@@@@y+.``````````do         SahiDemon V3.1.0         
echo                  oy                                  @@@@@@@@@@@@@@@o++.```````oy                  
echo                  +h                                  @@@@@@@@@@@@@@@@@@ss/`````ss                  
echo                  .N                                  @@@@@@@@@@@@@@@@@@@@s`````d:                  
echo                   d/                                 /+@@@@@@@@@@@@@@@@N+.````:@                   
...
echo                   -@`                       -hd@o ```      `     ```.````````s@:                   
echo                   h/                              :do``.........```.``.``````.N@                   
echo                  .N                                 `-/sy@@@@@@@+:::``````````:@:         Proxy Manager By         
echo                  /h                                   `:+@@@@@@@@@@@/-`````````yo         SahiDemon V3.1.0         
echo                  oy                                   -@@@@@@@@@@@@@@y++-``````oy                  
echo                  +h                                   -@@@@@@@@@@@@@@@@@ys/````ss                  
echo                  .N                                   -@@@@@@@@@@@@@@@@@@@o````d:                  
echo                   d/                                  ./s@@@@@@@@@@@@@@@N+.```:@                   
...
echo                   -@`                         oh@@- ``      ``   ```.````````:@:                   
echo                   h/                                od:``.........````````````y@                   
echo                  .N                                   .:os@@@@@@@d:::`.```````.N:         Proxy Manager By         
echo                  /h                                     .:h@@@@@@@@@@+:````````so         SahiDemon V3.1.0         
echo                  oy                                     o@@@@@@@@@@@@@d++-`````oy                  
echo                  +h                                     o@@@@@@@@@@@@@@@@ys:```ss                  
echo                  .N                                     s@@@@@@@@@@@@@@@@@@/```d:                  
echo                   d/                                    -/@@@@@@@@@@@@@@@N/.``:@                   
...
echo                   -@`                          `hh@h  ``     `` `````.```````.@:                   
echo                   h/                                 `dh``.......--```````````+@                   
echo                  .N                                     -:sy@@@@@@@/::..```````d:         Proxy Manager By         
echo                  /h                                       :/N@@@@@@@@@s/```````so         SahiDemon V3.1.0         
echo                  oy                                       @@@@@@@@@@@@@@++-````oy                  
echo                  +h                                       @@@@@@@@@@@@@@@@ys-``ss                  
echo                  .N                                       N@@@@@@@@@@@@@@@@@-``d:                  
echo                   d/                                      /o@@@@@@@@@@@@@@@/``:@                   
...
echo                   -@`                            :hd@+ ```     ````.``.``````.d:                   
echo                   h/                                   :@o``......--.`````````:@                   
echo                  .N                                      `:+sd@@@@@@s::-.``````d:         Proxy Manager By         
echo                  /h                                        `:s@@@@@@@@@h/``````so         SahiDemon V3.1.0         
echo                  oy                                        :@@@@@@@@@@@@N++.```oy                  
echo                  +h                                        :@@@@@@@@@@@@@@@yo``ss                  
echo                  .N                                        /@@@@@@@@@@@@@@@@d``d:                  
echo                   d/                                       ./d@@@@@@@@@@@@@h:`:@                   
...
echo                   -@`                              sh@@. ``     ```.``.``````.d:                   
echo                   h/                                     y@.`.....---.````````:@                   
echo                  .N                                        -/sy@@@@@@h::-.`````d:         Proxy Manager By         
echo                  /h                                          -:N@@@@@@@@h/`````so         SahiDemon V3.1.0         
echo                  oy                                          y@@@@@@@@@@@N++.``oy                  
echo                  +h                                          h@@@@@@@@@@@@@@s/`ss                  
echo                  .N                                          d@@@@@@@@@@@@@@@+`d:                  
echo                   d/                                         /o@@@@@@@@@@@@@o.:@                   
...
echo                   -@`                               .hd@y````    `...````````.d:                   
echo                   h/                                      .@s``..------```````:@                   
echo                  .N                                         `/+yd@@@@@@::-`````d:         Proxy Manager By         
echo                  /h                                           `:s@@@@@@@@d/````so         SahiDemon V3.1.0         
echo                  oy                                           .@@@@@@@@@@@N+/``oy                  
echo                  +h                                           -@@@@@@@@@@@@@@s.ss                  
echo                  .N                                           :@@@@@@@@@@@@@@N`d:                  
echo                   d/                                          ./@@@@@@@@@@@@N::@                   
...
echo                   -@`                                 /h@@:``.   ``..````````.d:                   
echo                   h/                                        o@-`..------``````:@                   
echo                  .N                                           -/sy@@@@@N::-````d:         Proxy Manager By         
echo                  /h                                             -/N@@@@@@@h:```so         SahiDemon V3.1.0         
echo                  oy                                             y@@@@@@@@@@@+-`oy                  
echo                  +h                                             h@@@@@@@@@@@@h/ss                  
echo                  .N                                             d@@@@@@@@@@@@@+d:                  
...
echo                   -@`                                  `yd@d``.. ```-.```````.d:                   
echo                   h/                                         .@s`..------`````:@                   
echo                  .N                                            `/oyN@@@@N::.```d:         Proxy Manager By         
echo                  /h                                              ./h@@@@@@@y-``so         SahiDemon V3.1.0         
echo                  oy                                              -@@@@@@@@@@h+`oy                  
echo                  +h                                              :@@@@@@@@@@@@sss                  
echo                  .N                                              +@@@@@@@@@@@@dd:                  
echo                   d/                                             -+@@@@@@@@@@N+@                   
...
echo                   -@`                                    :h@@/`.-````-.``````.d:                   
echo                   h/                                           s@-..-----.````:@                   
echo                  .N                                              :+yd@@@@N::.``d:         Proxy Manager By         
echo                  /h                                              ``/s@@@@@@@o.`so         SahiDemon V3.1.0         
echo                  oy                                              ``@@@@@@@@@@s:oy                  
echo                  +h                                              ``@@@@@@@@@@@dhs                  
echo                  .N                                              `.N@@@@@@@@@@@@:                  
echo                   d/                                             `./@@@@@@@@@@y@                   
...
echo                   -@`                                    ``sd@h`.-..``-.`````.d:                   
echo                   h/                                            -@o.------.```:@                   
echo                  .N                                               -+yh@@@@@:-``d:         Proxy Manager By         
echo                  /h                                              ```-+@@@@@@N/`so         SahiDemon V3.1.0         
echo                  oy                                              ```s@@@@@@@@@+oy                  
echo                  +h                                              ```s@@@@@@@@@Nds                  
echo                  .N                                              ```h@@@@@@@@@@@:                  
echo                   d/                                            ````/h@@@@@@@@@@                   
...
echo                   -@`                                    ```-d@@:.--``...````.d:                   
echo                   h/                                              hh.-----..``:@                   
echo                  .N                                               ``+sh@@@@d:.`d:         Proxy Manager By         
echo                  /h                                               ```./N@@@@@h.so         SahiDemon V3.1.0         
echo                  oy                                               ```:@@@@@@@@ysy                  
echo                  +h                                             ` ```/@@@@@@@@@@s                  
echo                  .N                                             ` ```o@@@@@@@@@@:                  
...
echo                   -@`                                      ```yd@y.--```-.```.d:                   
echo                   h/                                             ``o@-.--....`:@                   
echo                  .N                                               ```/oyN@@@s:`d:         Proxy Manager By         
echo                  /h                                               ```.`/@@@@@@/so         SahiDemon V3.1.0         
echo                  oy                                               ````.N@@@@@@@yy                  
echo                  +h                                             ` ```..@@@@@@@@Ns                  
echo                  .N                                             ``````:@@@@@@@@@:                  
echo                   d/                                            ``````-o@@@@@@@@                   
...
echo                   -@`                                       ```/d@@--:```-.``.d:                   
echo                   h/                                             ```:@:......`:@                   
echo                  .N                                              ``.``:ohN@@@:.d:         Proxy Manager By         
echo                  /h                                              ``.````/d@@@@hso         SahiDemon V3.1.0         
echo                  oy                                              ```````@@@@@@@hy                  
echo                  +h                                              ``.````N@@@@@@@s                  
echo                  .N                                              ``````-@@@@@@@@:                  
echo                   d/                                             ``````.o@@@@@@@                   
...
echo                   -@`                                        ```.h@N/-:```-``.d:                   
echo                   h/                                             ```..@+......:@                   
echo                  .N                                              ``````-ohN@@h-d:         Proxy Manager By         
echo                  /h                                              ````````:d@@@Nho         SahiDemon V3.1.0         
echo                  oy                                              ````````@@@@@@Ny                  
echo                  +h                                              ````````@@@@@@@s                  
echo                  .N                                              ```````.@@@@@@@:                  
echo                   d/                                             ```````.o@@@@@@                   
...
echo                   -@`                                          ```sd@o--``.-`.d:                   
echo                   h/                                             ``````d+.....:@                   
echo                  .N                                              ```.```-oh@@@/@:         Proxy Manager By         
echo                  /h                                              `````````:@@@@@o         SahiDemon V3.1.0         
echo                  oy                                              `````````@@@@@@y                  
echo                  +h                                              `````````@@@@@@s                  
echo                  .N                                              ````````.@@@@@@:                  
echo                   d/                                             ````````.s@@@@@                   
...
echo                   -@`                                            `.-:d@y--``-.d:                   
echo                   h/                                             `````.``d/...:@                   
echo                  .N                                               ```.````-sd@N@:         Proxy Manager By         
echo                  /h                                               `````````.o@@@o         SahiDemon V3.1.0         
echo                  oy                                               `````````.@@@@y                  
echo                  +d`                                            ` `````````-@@@@s                  
echo                  .@`                                            ` `````````/@@@@:                  
echo                   d/                                            ```````````-N@@@                   
...
echo                   -@`                                            ``.--h@y--`..d:                   
echo                   h/                                             ``.``..``d-../@                   
echo                  .N                                              ``.```````:yN@N:         Proxy Manager By         
echo                  /h                                               ``````````.h@@o         SahiDemon V3.1.0         
echo                  oy                                               ``````````/@@@y                  
echo                  +@-                                            ` ``````````+@@@s                  
echo                  .@:                                            ````````````y@@@:                  
echo                   do                                            ````````````+@@@                   
...
echo                   -@`                                           ```.``..--hd-.d:                   
echo                   h/                                              ````````...s:@                   
echo                  .N                                               ```````````.s@:         Proxy Manager By         
echo                  /h                                               ````````````.No         SahiDemon V3.1.0         
echo                  oy-                                              ````````````-@y                  
echo                  +h+o:                                            ````````````:@s                  
echo                  .N.s:                                          ` ````````````o@:                  
echo                   dh/:                                          ` ````````````s@                   
...
echo                   -@`                                            ``.````.-:ds.d:                   
echo                   h/                                             ``.```````..+/@                   
echo                  .N                                               ````````````/N:         Proxy Manager By         
echo                  /h                                               `````````````ho         SahiDemon V3.1.0         
echo                  od -                                             `````````````dy                  
echo                  +h`ho.                                         ` `````````````@s                  
echo                  .N /s.                                         ` ````````````-@:                  
echo                   ds+s                                          ``````````````/@                   
...
echo                   -@h`.o                                        ` ```.```````.d:                   
echo                   hN-                                            `````````````:@                   
echo                  .@. .                                           ```.``````````d:         Proxy Manager By         
echo                  /d-:h `-                                        ``````````````so         SahiDemon V3.1.0         
echo                  od/@o-.o  ./                                    ``````````````oy                  
echo                  +d.:.:    :@o++-`                               ``````````````ss                  
echo                  .N        `+yh+-`                               ``````````````d:                  
echo                   d/     :yy`/@`                                 `````````````:@                   
...
echo                   -N-y@@o.  +y                                  ` ```.```````.d:                   
echo                   h/ oN@-                                         ````````````:@                   
echo                  .N` s.   ..                                     ```.``````````d:         Proxy Manager By         
echo                  /h -:+`::do  `:`                                ``````````````so         SahiDemon V3.1.0         
echo                  oy `o::y@y+/ -s.   /:                           ``````````````oy                  
echo                  +h  .+.`o`-o      `@@+++/``                     ``````````````ss                  
echo                  .N                 +odh+/``                     ``````````````d:                  
echo                   d/            .yyy` dh                         `````````````:@                   
...
echo                   -@y`+@@No`  .@:                                ``.`````````.d:                   
echo                   hy  .N@@.                                      `````````````:@                   
echo                  .No  /o`   `-                                    ```.`````````d:         Proxy Manager By         
echo                  /h  .:o:`::s@`  .:`                              `````````````so         SahiDemon V3.1.0         
echo                  oy   ++::sNds/- :s`   //                         `````````````oy                  
echo                  +h    :/. +- +/       @@++++..                 ` `````````````ss                  
echo                  .N                    /+hdo+..                 ` `````````````d:                  
echo                   d/               -yyy. y@`                    ``````````````:@                   
...
echo                   -@@s``@@@Ny`   /@.                             ```.````````.d:                   
echo                   ho/   /N@@/                                    `````````````:@                   
echo                  .N/o  `o+.    .-                                ``````````````d:         Proxy Manager By         
echo                  /h    ::o/ :::@d   .:`                          ``.```````````so         SahiDemon V3.1.0         
...
echo                   -@yN- .N@@@d``  `@o                            ````.```````.d:                   
echo                   h/s`   /N@@s                                   `````````````:@                   
echo                  .N`d.  `oo.    `-`                              ``````````````d:         Proxy Manager By         
echo                  /h     ::oo -::s@:   ::                         ``````````````so         SahiDemon V3.1.0         
...
echo                   -@:@h. .@@@@@-`   o@`                         ` ```````````.d:                   
echo                   h/-o    /@@@d                                  `````````````:@                   
echo                  .N +h   `os-     -.                             ``````````````d:         Proxy Manager By         
echo                  /h      ::+y .:::Nd   `:-                       ``````````````so         SahiDemon V3.1.0         
echo                  oy       o+/-/s@@so/- -s/   `/:                 ``````````````oy                  
echo                  +h        -o:. /o `o/       :@@++++..           ``````````````ss                  
echo                  .N                          .+odh++..           ``````````````d:                  
echo                   d/                     `sss+ .@y               `````````````:@                   
...
echo                   -@`h@o` .N@@@No`   .@o                        ```.``.``````.d:                   
echo                   h/ y.    -@@@@-                                 ````````````:@                   
echo                  .N  ho   `/y-`    `-`                            `````````````d:         Proxy Manager By         
echo                  /h       :::h- :::s@:   -:`                     ``````````````so         SahiDemon V3.1.0         
...
echo                   -@`-@@/` `N@@@N@`    o@.                       ``.`````````.d:                   
echo                   h/ `d`    `@@@@s                                ````````````:@                   
echo                  .N  :d/   `:h:.     --                           `````````````d:         Proxy Manager By         
echo                  /h        -::y+ .:::N@    ::                     `````````````so         SahiDemon V3.1.0         
...
echo                   -@. y@@-`  @@@@@N/    `@y                      ```.````````.d:                   
echo                   h/  :y`     dN@@d`                             ``.``.```````:@                   
echo                  .N   od:   ``h+-     `-.                         `````````````d:         Proxy Manager By         
echo                  /h         -::+y` :::o@o   `:-                   `````````````so         SahiDemon V3.1.0         
...
echo                   -N- `@@@-`  y@@@@Nh     /@/                    ```.````````.d:                   
echo                   h/   os`     o@@@do                            `````````````:@                   
echo                  .N    yd:    `oy-.     .-`                      ``````````````d:         Proxy Manager By         
echo                  /h          .:::y/ .:::d@-   -:`                ``````````````so         SahiDemon V3.1.0         
...
echo                   -@+  .@@@-`  +N@@@@N:     h@`                  ````.```````.d:                   
echo                   h+    yo`     .@N@@d`                          `````````````:@                   
echo                  .@`    hd/    `:h/-      --                     ``````````````d:         Proxy Manager By         
echo                  /h            :::oy  :::/@@    ::               ``````````````so         SahiDemon V3.1.0         
...
echo                   -@h.  :@@@:`  .N@@@@Nd     -@s                ` ```.```````.d:                   
echo                   h+     ys`      h@@dds                          ````````````:@                   
echo                  .@:     hd+    ``yy-.     `-.                   ``````````````d:         Proxy Manager By         
echo                  /@             -::/y/ .:::s@s   `:-             ``````````````so         SahiDemon V3.1.0         
...
echo                   -N@:   +@@N+`   yN@@@@N+     o@:              ```.``.``````.d:                   
echo                   h+`     yy`      -@Nddd-                        ````````````:@                   
echo                  .@y      yds     `/h/-`     .-`                  `````````````d:         Proxy Manager By         
echo                  /N.             `:::oy` -:::d@-   .:.            `````````````so         SahiDemon V3.1.0         
...
echo                   -@@h.   +@@Ny`   :N@@@@NN`     dd              ``.`````````.d:                   
echo                   hy`      od.       h@@ddh                      `````````````:@                   
echo                  .@N.      sdh`    ``yy--      --                 `````````````d:         Proxy Manager By         
echo                  /@+               -:::ys  :::/@N    ::`          `````````````so         SahiDemon V3.1.0         
...
echo                   -Ny@/`   /@@N@`    dN@@@@Ny     :@o            ```.````````.d:                   
echo                   h@``      /@-`      -@Ndddo                    `````````````:@                   
echo                  .@@s       +hh:     `:ho-.     `-.              ``````````````d:         Proxy Manager By         
echo                  /@h.               `:::+y: .:::o@y   `::         `````````````so         SahiDemon V3.1.0         
...
echo                   -@o@@-    -N@@N:`   :N@@@@@@:     s@-          ```.````````.d:                   
echo                   h@/`       .@+`       y@@ddd-                  `````````````:@                   
echo                  .@@N-       :hhs     ``oh:-      .-`            ``````````````d:         Proxy Manager By         
echo                  /@N+                 -:::sy` -:::h@/   .:.      ``````````````so         SahiDemon V3.1.0         
...
echo                   h@h`         @h.`      `N@dddh                 `````````````:@                   
echo                  .@@@@        `hhh.     `.hy--      --           ``````````````d:         Proxy Manager By         
echo                  /@@h-                  /::/ys  :::/N@`   ::     ``````````````so         SahiDemon V3.1.0         
...
echo                   -@@:@@s`     hN@NN.    -NN@@@@@s     /@/      `````````````.d:                   
echo                   h@@/`         o@-`       /@Ndddo                ````````````:@                   
echo                  .@@@@y         ohho     `./h+-.     `--         ``````````````d:         Proxy Manager By         
echo                  /@@Ns.                  ./::+y/ `:::+@d   `:-   ```.``````````so         SahiDemon V3.1.0         
...
echo                   h@@N.`         `@y.`       h@@ddd-              ````````````:@                   
echo                  .@@@@No         -hhh.     `.sh:-`     .-`        `````````````d:         Proxy Manager By         
echo                  /@@@@+`                   :/::sy. -:::h@+   -:`  `````````````so         SahiDemon V3.1.0         
...
echo                   -@@@:d@@o`     `N@@NN.    `@N@@@@@@     :@o    ``..````````.d:                   
echo                   h@@@y``          y@-.       `@@dddh         `  ``.``````````:@                   
echo                  .@@@@@N+          shhy      ..hy--      --       `````````````d:         Proxy Manager By         
echo                  /@@@@h/`                   `/::/yy  :::/N@`  `:- `````````````so         SahiDemon V3.1.0         
...
echo                   h@@@@o``          .@y.`       +@Nd@do       `` `````````````:@                   
echo                  .@@@@@@N+          -hhh:     `./ho-.     `-.    ``.```````````d:         Proxy Manager By         
echo                  /@@@@@h/`                    ./::+y+ `:::o@y   -/`````````````so         SahiDemon V3.1.0         
...
echo                   h@@@@@+``           s@/.        h@@d@@-      `````.`````````:@                   
echo                  .@@@@@@@No           shhh`     `.sh/-`     .-`  ``````````````d:         Proxy Manager By         
echo                  /@@@@@Nh/.                     :/::sh- .:::d@-  ./-```````````so         SahiDemon V3.1.0         
...
echo                   h@@@@@@+``           `@@..       `@@@@@h       ..```````````:@                   
echo                  .@@@@@@@@Ny           `hhho      ..hh--     `-. ```.``````````d:         Proxy Manager By         
echo                  /@@@@@@Nh/.                      //::yy` :::+@h ``:/``````````so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@+`.            +@o.`       /@N@@@/      ..``````````:@                   
echo                  .@@@@@@@@@Nd            /hhh:     `./ho-.     .:``````````````d:         Proxy Manager By         
echo                  /@@@@@@@@h+-                      .//:+ho `:::h@-``-/`````````so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@@o..             d@:.        h@@@@d     `...````````:@                   
echo                  .@@@@@@@@@@N@.            yhhh`     `.sh/-`    `:-````````````d:         Proxy Manager By         
echo                  /@@@@@@@@@ho:                       ://:sh- -::+@y``./.```````so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@@@h..`            .@d..       .@@@@@+  ``.`-.```````:@                   
echo                  .N@@@@@@@@@@@@+            .hhhs      .-hy--     -:```````````d:         Proxy Manager By         
echo                  /h@@@@@@@@@dy:.                       //:/hy `://dN```/-``````so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@@@@N...             o@o.`       s@N@@d `````..``````:@                   
echo                  .NN@@@@@@@@@@@Nd             /hhh/     `.+h+-`  ``-:.`````````d:         Proxy Manager By         
echo                  /hs@@@@@@@@@@h/-                       .+/:oh/ -//s@:``:-`````so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@@@@@@:..`             @@:.       `N@@@@/``.``..`````:@                   
echo                  .@@@@@@@@@@@@@@N@:             yhhh.     ..yh:- ```.:.````````d:         Proxy Manager By         
echo                  /d-N@@@@@@@@@Nho:`                       :+/:yh .//+@o``:-````so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@@@@@@@s...             .@d..       +@N@@y````...````:@                   
echo                  .@@N@@@@@@@@@@@@@@h             .hhhy      ./do:.``.`:-```````d:         Proxy Manager By         
echo                  /@`s@@@@@@@@@@@dy:-                       `++:oh/`///@y``:.```so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@@@@@@@@N...`             o@o.`      `N@@@@..``...```:@                   
echo                  .@N@@@@@@@@@@@@@@@N@/             /hhh/     `.yh:-````--``````d:         Proxy Manager By         
echo                  /@/.@@@@@@@@@@@@@ho:`                       -+//hy`://dd``/.``so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@@@@@@@@@@o...              @@-.       o@N@@:```...``:@                   
echo                  .@@dN@@@@@@@@@@@@@@@@@              shhh.     .+d+:`.``--`````d:         Proxy Manager By         
echo                  /@y /N@@@@@@@@@@@@hy/:                        ++:sd-.//hd`.:``so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@@@@@@@@@@@N...`             -@d..      -@N@@+```.-.`:@                   
echo                  .N@NdN@@@@@@@@@@@@@@@N@o             `hhhs     .-hy:.```--````d:         Proxy Manager By         
echo                  /hy: s@@@@@@@@@@@@@Nhs:.                       :o/+d/.//yh`.-`so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@@@@@@@@@@@@@o...`             s@+.`    ``d@@@s```..`:@                   
echo                  .Nd@@d@@@@@@@@@@@@@@@@@N@-             /hhh:    `-sd:-```-.```d:         Proxy Manager By         
echo                  /hoy` y@@@@@@@@@@@@@@dh+/`                      `o+/hs`//hs`:`so         SahiDemon V3.1.0         
...
echo                   h@@@@@@@@@@@@@@@@@@@@@-...              NN..   ```s@NNs``...:@                   
echo                  .No@@dd@@@@@@@@@@@@@@@@@@@d              yhhy   ``-+d/-```-.``d:         Proxy Manager By         
echo                  /h-ho `h@@@@@@@@@@@@@@Nhy/:                     ``+o/yy`:/d/.-so         SahiDemon V3.1.0         
...
echo                   hs@@@@@@@@@@@@@@@@@@@@@h...`             /@o.`  ```/@NNs``..:@                   
echo                  .N.N@Ndd@@@@@@@@@@@@@@@@@@N@o             -hdd/ ```.:d+-```-``d:         Proxy Manager By         
echo                  /h sh/ `y@@@@@@@@@@@@@@@@hs/-                   ```:o/sh`:/@.-so         SahiDemon V3.1.0         
...
echo                   h/d@@@@@@@@@@@@@@@@@@@@@@/...`             @N-. ```.-@NNo`..:@                   
echo                  .N s@@@dd@@@@@@@@@@@@@@@@@@@N@-             oddy ```.-ho-``..`d:         Proxy Manager By         
echo                  /h .hh: `yN@@@@@@@@@@@@@@@dh+/`                  ```.o+oh`/+y.yo         SahiDemon V3.1.0         
...
echo                   h//@@@@@@@@@@@@@@@@@@@@@@@N....             /@o.````.-@NN/`./@                   
echo                  .N .N@@@dd@@@@@@@@@@@@@@@@@@@@@@             .ddd:````-ho-``-`d:         Proxy Manager By         
echo                  /h  +hh-  y@@@@@@@@@@@@@@@@Nhy//                 `````o+oy./y:yo         SahiDemon V3.1.0         
...
echo                   h/ @@@@@@@@@@@@@@@@@@@@@@@@@y...`             N@-.```..NN@../@                   
echo                  .N  +N@@@ddN@@@@@@@@@@@@@@@@@@@N@s             sdds````-h+-``.d:         Proxy Manager By         
echo                  /h   shy-  sd@@@@@@@@@@@@@@@@@hs/-               ``````++ss./yyo         SahiDemon V3.1.0         
echo                  oy          /@@@@@@@@@@@@@@@h+                   ```````/yo+@yyy                  
echo                  +h          :@@@@@@@@@@@@@@s.`                 ``````````-o:/:ys                  
echo                  .N          `+h@@@@@@@@@@@@o                   `````````````.-d:                  
echo                   d/           :@@@@@@@@@@@@s                    ````````````.:@                   
...
echo                   h/ :@@@@@@@@@@@@@@@@@@@@@@@@@@/...`            o@:-```.-@Ny`/@                   
echo                  .N   y@@@@dd@@@@@@@@@@@@@@@@@@@@@N@:            :ddh````-h/.`.d:         Proxy Manager By         
echo                  /h   `yyy:  /h@@@@@@@@@@@@@@@@@dho/.            ``.`````++s/:yyo         SahiDemon V3.1.0         
echo                  oy            N@@@@@@@@@@@@@@dh-`               `````````/s+s@yy                  
echo                  +h            N@@@@@@@@@@@@@@:.                 ``.```````:o-/hs                  
echo                  .N            /o@@@@@@@@@@@@@-                  `````````````.d:                  
echo                   d/             N@@@@@@@@@@@@-                  `````````````:@                   
...
echo                   h/  s@@@@@@@@@@@@@@@@@@@@@@@@@@N....           `-@o-```.:@N::@                   
echo                  .N   `d@@@Nddd@@@@@@@@@@@@@@@@@@@@@N@`          ``hdd-```-d:`.@:         Proxy Manager By         
echo                  /h    .yyy/  .y@@@@@@@@@@@@@@@@@@hh+/           `````````+/h-+@o         SahiDemon V3.1.0         
echo                  oy             s@@@@@@@@@@@@@@@hy``             ``````````+s+ddy                  
echo                  +d             s@@@@@@@@@@@@@@N..               ```````````++:ys                  
echo                  .@`            -+d@@@@@@@@@@@@@                 `````````````.d:                  
echo                   d/              o@@@@@@@@@@@@@                 `````````````:@                   
...
echo                   h/   d@@@@@@@@@@@@@@@@@@@@@@@@@@@y....          ``@h-.``.o@h:@                   
echo                  .N    .d@@@@hddN@@@@@@@@@@@@@@@@@@@@@Ny         ```sdd:```:y-`@:         Proxy Manager By         
echo                  /h     .yyys   sh@@@@@@@@@@@@@@@@@Nhy/:         ``````````o/s-@o         SahiDemon V3.1.0         
echo                  oy              .@@@@@@@@@@@@@@@Nhs``           ```````````oooNy                  
echo                  +@`             .@@@@@@@@@@@@@@@y..             ````````````o:hs                  
echo                  .@:              +s@@@@@@@@@@@@@s               ``````````````d:                  
echo                   d+               `@@@@@@@@@@@@@s              ``````````````:@                   
...
echo                   h/   `@@@@@@@@@@@@@@@@@@@@@@@@@@@@@/...`        ```y@-.``.dN+@                   
echo                  .N     .d@@@@dhh@@@@@@@@@@@@@@@@@@@@@@NN:        ```/dd/```o+.d:         Proxy Manager By         
echo                  /h      `yyyy`  :y@@@@@@@@@@@@@@@@@@@hs+.        `````````.os:ho         SahiDemon V3.1.0         
echo                  oy                y@@@@@@@@@@@@@@@@h/``          ``````````.soNy                  
echo                  +@-               y@@@@@@@@@@@@@@@+.`            ```````````-+hs                  
echo                  .@y               -+d@@@@@@@@@@@@@:            ` `````````````d:                  
echo                   dh                 o@@@@@@@@@@@@@-            ``````````````:@                   
...
echo                   -@`    yN@@@@@@@@@@@@@@@@@@@@@@@@@@.-NNNNNo`   ```:@@@d.`+@@@:                   
echo                   h/    `@@@@@@@@@@@@@@@@@@@@@@@@@@@@@N....      ``.``oN-.``:@h@                   
echo                  .N      .d@@@@@hhh@@@@@@@@@@@@@@@@@@@@@@N@       ````-dd+``.y-d:         Proxy Manager By         
echo                  /h       `yyyy:   yh@@@@@@@@@@@@@@@@@@dd++       ``````````-+oyo         SahiDemon V3.1.0         
echo                  oh                 .@@@@@@@@@@@@@@@@dh-.         ```````````/ody                  
echo                  +N+                `@@@@@@@@@@@@@@@N--         ` ````````````+ys                  
echo                  .@@`                +o@@@@@@@@@@@@@N           ` `````````````d:                  
echo                   dN`                  N@@@@@@@@@@@@N           ``````````````:@                   
...
echo                   h/     `@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@y...`    `````.+N-.`.yN@                   
echo                  .N       `hN@@@@hhh@@@@@@@@@@@@@@@@@@@@@@@No    ``````.d@/``/+d:         Proxy Manager By         
echo                  /h         syyys   :y@@@@@@@@@@@@@@@@@@Ndy+:    ````````````/oyo         SahiDemon V3.1.0         
echo                  od`                  o@@@@@@@@@@@@@@@Nhy..       ````````````shy                  
echo                  +@s-                 o@@@@@@@@@@@@@@@d-.        `````````````-hs                  
echo                  .@@s                 -+h@@@@@@@@@@@@@y          ``````````````d:                  
echo                   d@o                   /@@@@@@@@@@@@@s          `````````````:@                   
...
echo                   -@`      yN@@@@@@@@@@@@@@@@@@@@@@@@@@N-.@NNNNo`````..N@@s.:@@:                   
echo                   h/      `d@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@:...   ```.``./@-``:@@                   
echo                  .N         h@@@@@@hhhN@@@@@@@@@@@@@@@@@@@@@NN`  ```````.d@:`.o@:         Proxy Manager By         
echo                  /h          +yyyy-   sy@@@@@@@@@@@@@@@@@@@ds+`  ````````````.+do         SahiDemon V3.1.0         
echo                  o@-                    N@@@@@@@@@@@@@@@@d+.`    `````````````:hy                  
echo                  +@d+                   N@@@@@@@@@@@@@@@o-`      ``````````````ds                  
echo                  .@@@-                  /+N@@@@@@@@@@@@@:        ``````````````d:                  
echo                   d@N.                    d@@@@@@@@@@@@@-        `````````````:@                   
...
echo                   h/        dN@@@@@@@@@@@@@@@@@@@@@@@@@@@@@d...` ```````.+d.`.h@                   
echo                  .N          od@@@@@hhhd@@@@@@@@@@@@@@@@@@@@@@Ns ```.````.dd.`/@:         Proxy Manager By         
echo                  /@           -yyyys   -yd@@@@@@@@@@@@@@@@@@dh+/ `````````````/do         SahiDemon V3.1.0         
echo                  o@+                     :@@@@@@@@@@@@@@@@dh-.   ``````````````dy                  
echo                  +@@s/                   :@@@@@@@@@@@@@@@@:-     ``````````````ys                  
echo                  .@@@@                   .+s@@@@@@@@@@@@@N       ``````````````d:                  
echo                   d@@y                     .@@@@@@@@@@@@@@       `````````````:@                   
...
echo                   -@`        /@@@@@@@@@@@@@@@@@@@@@@@@@@@@N:.@NNNN:.``.`.N@N.+@:                   
echo                   h/         s@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@/... ```````.oy.`o@                   
echo                  .N`          :h@@@@@@hhhN@@@@@@@@@@@@@@@@@@@@@NN`````````-@y`.N:         Proxy Manager By         
echo                  /@.            syyyy-   +y@@@@@@@@@@@@@@@@@@Ndyo.````````````.ho         SahiDemon V3.1.0         
echo                  o@y-                      s@@@@@@@@@@@@@@@Nds-. ``````````````yy                  
echo                  +@@@o-                    s@@@@@@@@@@@@@@@h-.   ``````````````ss                  
echo                  .@@@@y                    :+h@@@@@@@@@@@@@s     ``````````````d:                  
echo                   d@@@/                      o@@@@@@@@@@@@@+    ``````````````:@                   
...
echo                   h/          /@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@d....```````.y/./@                   
echo                  .N`           `h@@@@@@hhhh@@@@@@@@@@@@@@@@@@@@@@N+````````/@/`@:         Proxy Manager By         
echo                  /@s             /yyyyy    yy@@@@@@@@@@@@@@@@@@@do/````````````ho         SahiDemon V3.1.0         
echo                  o@N/.                       N@@@@@@@@@@@@@@@@d:- `````````````oy                  
echo                  +@@@yo.                     N@@@@@@@@@@@@@@@+:`` `````````````ss                  
echo                  .@@@@@o                     ++N@@@@@@@@@@@@@.  ` `````````````d:                  
echo                   d@@@@-                       d@@@@@@@@@@@@N`  ``````````````:@                   
...
echo                   -@`           d@@@@@@@@@@@@@@@@@@@@@@@@@@@NN:-NN@@d-````/@@-@:                   
echo                   h/           .@N@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@/---```````.d.:@                   
echo                  .@:             oh@@@@@Nhhhd@@@@@@@@@@@@@@@@@@@@@Nd````````oh`d:         Proxy Manager By         
echo                  /@@.              yyyyy/   -yh@@@@@@@@@@@@@@@@@Ndyo```````````yo         SahiDemon V3.1.0         
echo                  o@@y/                        -@@@@@@@@@@@@@@@Nds-.````````````oy                  
echo                  +@@@@o+`                     -@@@@@@@@@@@@@@@@:- `````````````ss                  
echo                  .@@@@@@/                     `+s@@@@@@@@@@@@@y ```````````````d:                  
echo                   d@@@@d.                       .@@@@@@@@@@@@@o ```.``````````:@                   
...
echo                   -@`            o@@@@@@@@@@@@@@@@@@@@@@@@@@@@Nh.h@@@@-````y@sd:                   
echo                   h/             y@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@h---``````./o:@                   
echo                  .@s`             .h@@@@@@dhhhN@@@@@@@@@@@@@@@@@@@@@N.```````d/d:         Proxy Manager By         
echo                  /@@s               /yyyyy.   +y@@@@@@@@@@@@@@@@@@@ho-`````````so         SahiDemon V3.1.0         
echo                  o@@@+:                         o@@@@@@@@@@@@@@@@d:-```````````oy                  
echo                  +@@@@N++.                      o@@@@@@@@@@@@@@@o:`.```````````ss                  
echo                  .@@@@@@@/                      -+h@@@@@@@@@@@@@.``````````````d:                  
echo                   d@@@@@h.                        o@@@@@@@@@@@@N``````````````:@                   
...
echo                   -@`             `N@@@@@@@@@@@@@@@@@@@@@@@@@@@NN-+@@@N-```.@@d:                   
echo                   h/              :@N@@@@@@@@@@@@@@@@@@@@@@@@@@@@@N---.`````.y/@                   
echo                  .@@.               oh@@@@@@hhhh@@@@@@@@@@@@@@@@@@@@@N/``````/yd:         Proxy Manager By         
echo                  /@@N-                yyyyyy    syN@@@@@@@@@@@@@@@@Ndo:````````so         SahiDemon V3.1.0         
echo                  o@@@d/:                          d@@@@@@@@@@@@@@Ndo:``````````oy                  
echo                  +@@@@@@++.                       d@@@@@@@@@@@@@@d:-```````````ss                  
echo                  .@@@@@@@@+                       /+@@@@@@@@@@@@@y`````````````d:                  
echo                   d@@@@@@y-                         d@@@@@@@@@@@@+````````````:@                   
...
echo                   -@.               y@@@@@@@@@@@@@@@@@@@@@@@@@@@@No:N@@N:```+@N:                   
echo                   h/                h@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@+--..````/s@                   
echo                  .@@+.               .hd@@@@@Nhhhd@@@@@@@@@@@@@@@@@@@@No``````h@:         Proxy Manager By         
echo                  /@@@h.                -yyyyy+   .yh@@@@@@@@@@@@@@@@N@s/```````so         SahiDemon V3.1.0         
echo                  o@@@@h/:                          `@@@@@@@@@@@@@@@@h:.````````oy                  
echo                  +@@@@@@@++-                       .@@@@@@@@@@@@@@@/:``````````ss                  
echo                  .@@@@@@@@@s                       `+o@@@@@@@@@@@@N````````````d:                  
echo                   d@@@@@@@h-                         .@@@@@@@@@@@@d```````````:@                   
...
echo                   -@.                .@@@@@@@@@@@@@@@@@@@@@@@@@@@@Nh-@@@N:``.@@:                   
echo                   h/                 :dN@@@@@@@@@@@@@@@@@@@@@@@@@@@@@y--.````.y@                   
echo                  .@@N.`                +hN@@@@@dhhh@@@@@@@@@@@@@@@@@@@@Ns`````+N:         Proxy Manager By         
echo                  /N@@@s`                 oyyyyy-   /yd@@@@@@@@@@@@@@@@@y+``````so         SahiDemon V3.1.0         
echo                  o@@@@@s/:                           +@@@@@@@@@@@@@@Nd:-```````oy                  
echo                  +@@@@@@@@++:                        +@@@@@@@@@@@@@@y:`````````ss                  
echo                  .@@@@@@@@@@d                        -+h@@@@@@@@@@@@/``````````d:                  
echo                   dN@@@@@@@d:                          o@@@@@@@@@@@@.`````````:@                   
